...
func updateFile(name string, bucket *couchbase.Bucket) {
	...
	// todo: if file has changed, then original file should be deleted, but there's no op reacting to it.
	checkFile := File{}
...
func main() {
	...
	// receive notifications from remote endpoint & update filehash
